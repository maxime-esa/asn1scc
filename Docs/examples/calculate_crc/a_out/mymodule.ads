...
type Packet_extension_function_positions is record
    Packet_packet_length_in_bytes : adaasn1rtl.encoding.BitstreamPtr;
...
ERR_PACKET:CONSTANT INTEGER := 153; 
ERR_PACKET_P_HEADER:CONSTANT INTEGER := 99; 
ERR_PACKET_P_HEADER_VERSION:CONSTANT INTEGER := 71; 
ERR_PACKET_P_HEADER_RELEASE:CONSTANT INTEGER := 78; 
ERR_PACKET_P_HEADER_VARSIZEARRAY:CONSTANT INTEGER := 92; 
ERR_PACKET_P_HEADER_VARSIZEARRAY_ELM:CONSTANT INTEGER := 85; 
ERR_PACKET_P_BODY:CONSTANT INTEGER := 140; 
ERR_PACKET_P_BODY_AREAL:CONSTANT INTEGER := 112; 
ERR_PACKET_P_BODY_ANINTEGER:CONSTANT INTEGER := 119; 
ERR_PACKET_P_BODY_ANOTHERSIZEARRAY:CONSTANT INTEGER := 133; 
ERR_PACKET_P_BODY_ANOTHERSIZEARRAY_ELM:CONSTANT INTEGER := 126; 
FUNCTION Packet_IsConstraintValid(val : in Packet) return adaasn1rtl.ASN1_RESULT;

ERR_ACN_ENCODE_PACKET:CONSTANT INTEGER := 156; 
...
ERR_ACN_ENCODE_PACKET_PACKET_LENGTH_IN_BYTES:CONSTANT INTEGER := 110; 
ERR_ACN_ENCODE_PACKET_P_BODY:CONSTANT INTEGER := 143; 
ERR_ACN_ENCODE_PACKET_P_BODY_AREAL:CONSTANT INTEGER := 115; 
ERR_ACN_ENCODE_PACKET_P_BODY_ANINTEGER:CONSTANT INTEGER := 122; 
ERR_ACN_ENCODE_PACKET_P_BODY_ANOTHERSIZEARRAY:CONSTANT INTEGER := 136; 
ERR_ACN_ENCODE_PACKET_P_BODY_ANOTHERSIZEARRAY_ELM:CONSTANT INTEGER := 129; 
ERR_ACN_ENCODE_PACKET_PACKET_CRC32:CONSTANT INTEGER := 151; 
Packet_REQUIRED_BYTES_FOR_ACN_ENCODING:CONSTANT INTEGER := 122;
Packet_REQUIRED_BITS_FOR_ACN_ENCODING:CONSTANT INTEGER := 972;
...
ERR_ACN_DECODE_PACKET:CONSTANT INTEGER := 157; 
...
ERR_ACN_DECODE_PACKET_PACKET_LENGTH_IN_BYTES:CONSTANT INTEGER := 111; 
ERR_ACN_DECODE_PACKET_P_BODY:CONSTANT INTEGER := 144; 
ERR_ACN_DECODE_PACKET_P_BODY_AREAL:CONSTANT INTEGER := 116; 
ERR_ACN_DECODE_PACKET_P_BODY_ANINTEGER:CONSTANT INTEGER := 123; 
ERR_ACN_DECODE_PACKET_P_BODY_ANOTHERSIZEARRAY:CONSTANT INTEGER := 137; 
ERR_ACN_DECODE_PACKET_P_BODY_ANOTHERSIZEARRAY_ELM:CONSTANT INTEGER := 130; 
ERR_ACN_DECODE_PACKET_PACKET_CRC32:CONSTANT INTEGER := 152; 

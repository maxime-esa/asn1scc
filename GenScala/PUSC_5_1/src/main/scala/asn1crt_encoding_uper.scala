...
def ObjectIdentifier_subidentifiers_uper_decode(pBitStrm: BitStream, pRemainingOctets: Ref[Int64], siValue: Ref[UInt64]): Boolean = {
...
def ObjectIdentifier_uper_decode_lentg(pBitStrm: BitStream, totalSize: Ref[Int64]): Boolean = {

...
//                | Some childContent ->
                let childBody = 
                    ...
                    | None  ->
                        match ec with
                        | CEC_uper  -> 
                            Some (choiceChild p.arg.p (lm.lg.getAcces p.arg) (lm.lg.presentWhenName (Some defOrRef) child) (BigInteger idx) nIndexSizeInBits nMax childContent_funcBody sChildName sChildTypeDef sChoiceTypeName lm.lg.acn.choice_requires_tmp_decoding codec)
                        | CEC_enum (enm,_) -> 
                            ...
                            Some (choiceChild_Enum p.arg.p (lm.lg.getAcces p.arg) (lm.lg.getNamedItemBackendName (Some (getDefOrRef enm)) enmItem  ) (lm.lg.presentWhenName (Some defOrRef) child) childContent_funcBody sChildName sChildTypeDef sChoiceTypeName lm.lg.acn.choice_requires_tmp_decoding codec)
                        | CEC_presWhen  ->
                            ...
                            Some (choiceChild_preWhen p.arg.p (lm.lg.getAcces p.arg) (lm.lg.presentWhenName (Some defOrRef) child) childContent_funcBody conds (idx=0) sChildName sChildTypeDef sChoiceTypeName lm.lg.acn.choice_requires_tmp_decoding codec)

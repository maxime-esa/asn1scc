...
let abstractMacros_ACN_IntegerMacros =
    {new ACN.IntegerMacros() with
            ...
            member this.positiveInteger_ConstSize_big_endian_16 (p:string) (sErrCode:string) (soMF:string option) (soMFM:string option) (nUperMin:BigInteger) (nUperMax:BigInteger) codec =
                acn_c.PositiveInteger_ConstSize_big_endian_16 (p:string) (sErrCode:string) (soMF:string option) (soMFM:string option) (nUperMin:BigInteger) (nUperMax:BigInteger) codec 
            }

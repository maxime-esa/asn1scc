...
TYPE CH2_selection IS (CH2_left_PRESENT, center_PRESENT);
for CH2_selection use
    (CH2_left_PRESENT => 1, center_PRESENT => 2);
...
TYPE CH1_selection IS (CH1_left_PRESENT, right_PRESENT);
for CH1_selection use
    (CH1_left_PRESENT => 1, right_PRESENT => 2);

...
FUNCTION OTHERCOLORS_uPER_enc_dec(val:MOD1.OTHERCOLORS) RETURN adaasn1rtl.TEST_CASE_RESULT
IS
    decodedPDU  : MOD1.OTHERCOLORS;
    stream      : MOD1.OTHERCOLORS_uPER_Stream;
    result      : adaasn1rtl.ASN1_RESULT;
    ret         : adaasn1rtl.TEST_CASE_RESULT;
BEGIN
    -- Check value against ASN.1 constraints
    result := MOD1.OTHERCOLORS_IsConstraintValid(val);
    ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_VALIDATE, Success => result.Success, ErrorCode => result.ErrorCode);
    IF result.Success THEN
        -- Encode value
        MOD1.OTHERCOLORS_uPER_Encode(val, stream, result);
        ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_DECODE, Success => result.Success, ErrorCode => result.ErrorCode);
        IF result.Success THEN
            -- Decode value
            --at this point stream contains the uPER data
            MOD1.OTHERCOLORS_uPER_Decode(decodedPDU, stream, result);
            ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_DECODE, Success => result.Success, ErrorCode => result.ErrorCode);
            IF result.Success THEN
                -- validate decoded data
                result := MOD1.OTHERCOLORS_IsConstraintValid(decodedPDU);
                ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_VALIDATE_DECODED, Success => result.Success, ErrorCode => result.ErrorCode);
                IF result.Success THEN
                    ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_EQUAL, Success => OTHERCOLORS_Equal(val, decodedPDU), ErrorCode => result.ErrorCode);
    ...
    END IF;
    RETURN ret;
END OTHERCOLORS_uPER_enc_dec;

FUNCTION CH2_uPER_enc_dec(val:MOD1.CH2) RETURN adaasn1rtl.TEST_CASE_RESULT
IS
    decodedPDU  : MOD1.CH2;
    stream      : MOD1.CH2_uPER_Stream;
    result      : adaasn1rtl.ASN1_RESULT;
    ret         : adaasn1rtl.TEST_CASE_RESULT;
BEGIN
    -- Check value against ASN.1 constraints
    result := MOD1.CH2_IsConstraintValid(val);
    ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_VALIDATE, Success => result.Success, ErrorCode => result.ErrorCode);
    IF result.Success THEN
        -- Encode value
        MOD1.CH2_uPER_Encode(val, stream, result);
        ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_DECODE, Success => result.Success, ErrorCode => result.ErrorCode);
        IF result.Success THEN
            -- Decode value
            --at this point stream contains the uPER data
            MOD1.CH2_uPER_Decode(decodedPDU, stream, result);
            ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_DECODE, Success => result.Success, ErrorCode => result.ErrorCode);
            IF result.Success THEN
                -- validate decoded data
                result := MOD1.CH2_IsConstraintValid(decodedPDU);
                ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_VALIDATE_DECODED, Success => result.Success, ErrorCode => result.ErrorCode);
                IF result.Success THEN
                    ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_EQUAL, Success => CH2_Equal(val, decodedPDU), ErrorCode => result.ErrorCode);
    ...
    END IF;
    RETURN ret;
END CH2_uPER_enc_dec;

FUNCTION CH2_left_uPER_enc_dec(val:MOD1.CH2_left) RETURN adaasn1rtl.TEST_CASE_RESULT
IS
    decodedPDU  : MOD1.CH2_left;
    stream      : MOD1.CH2_left_uPER_Stream;
    result      : adaasn1rtl.ASN1_RESULT;
    ret         : adaasn1rtl.TEST_CASE_RESULT;
BEGIN
    -- Check value against ASN.1 constraints
    result := MOD1.CH2_left_IsConstraintValid(val);
    ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_VALIDATE, Success => result.Success, ErrorCode => result.ErrorCode);
    IF result.Success THEN
        -- Encode value
        MOD1.CH2_left_uPER_Encode(val, stream, result);
        ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_DECODE, Success => result.Success, ErrorCode => result.ErrorCode);
        IF result.Success THEN
            -- Decode value
            --at this point stream contains the uPER data
            MOD1.CH2_left_uPER_Decode(decodedPDU, stream, result);
            ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_DECODE, Success => result.Success, ErrorCode => result.ErrorCode);
            IF result.Success THEN
                -- validate decoded data
                result := MOD1.CH2_left_IsConstraintValid(decodedPDU);
                ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_VALIDATE_DECODED, Success => result.Success, ErrorCode => result.ErrorCode);
                IF result.Success THEN
                    ret := adaasn1rtl.TEST_CASE_RESULT'(Step => adaasn1rtl.TC_EQUAL, Success => CH2_left_Equal(val, decodedPDU), ErrorCode => result.ErrorCode);

...
#define ENUM_RGBCOLORS_green	RGBCOLORS_green
#define ENUM_RGBCOLORS_blue	RGBCOLORS_blue
#define ENUM_OTHERCOLORS_red	OTHERCOLORS_red
#define ENUM_OTHERCOLORS_cyan	OTHERCOLORS_cyan
#define ENUM_OTHERCOLORS_magenta	OTHERCOLORS_magenta
#define CHOICE_CH2_left_PRESENT	CH2::CH2_left_PRESENT
#define CHOICE_CH2_center_PRESENT	CH2::CH2_center_PRESENT
#define CHOICE_CH1_left_PRESENT	CH1::CH1_left_PRESENT
#define CHOICE_CH1_right_PRESENT	CH1::CH1_right_PRESENT

...
BEGIN
    ...
    result := MOD1_auto_encs_decs.RGBCOLORS_uPER_enc_dec(RGBCOLORS_red);
    ...
    result := MOD1_auto_encs_decs.RGBCOLORS_uPER_enc_dec(RGBCOLORS_green);
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>
    ...
    result := MOD1_auto_encs_decs.RGBCOLORS_uPER_enc_dec(RGBCOLORS_blue);
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>
    ...
    result := MOD1_auto_encs_decs.CH1_uPER_enc_dec(CH1_right_set(RGBCOLORS_red));
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>
    ...
    result := MOD1_auto_encs_decs.OTHERCOLORS_uPER_enc_dec(OTHERCOLORS_red);
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>
    ...
    result := MOD1_auto_encs_decs.OTHERCOLORS_uPER_enc_dec(OTHERCOLORS_cyan);
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>
    ...
    result := MOD1_auto_encs_decs.OTHERCOLORS_uPER_enc_dec(OTHERCOLORS_magenta);
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>
    ...
    result := MOD1_auto_encs_decs.CH2_uPER_enc_dec(CH2_center_set(OTHERCOLORS_red));
    IF NOT result.Success THEN
        CASE result.Step IS
            WHEN adaasn1rtl.TC_VALIDATE =>

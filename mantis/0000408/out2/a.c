...
flag T_enum_IsConstraintValid(const T_enum* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = (((*pVal == T_enum_pink) || (*pVal == T_enum_yellow)) || (*pVal == T_enum_brown));
	*pErrCode = ret ? 0 : ERR_T_enum;
...
flag MySeq_myEnum_4_IsConstraintValid(const MySeq_myEnum_4* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = (((*pVal == MySeq_myEnum_4_pink) || (*pVal == MySeq_myEnum_4_yellow)) || (*pVal == MySeq_myEnum_4_brown)) && ((*pVal == MySeq_myEnum_4_yellow) || (*pVal == MySeq_myEnum_4_brown));

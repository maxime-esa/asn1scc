...
namespace parseStg2
{
    ...
    class Program
    {
        ...
        static int emitSingleFile(XDocument doc,string curDir)
        {
            ...
            using (var txt = new StreamWriter(@"C:\prj\GitHub\asn1scc\CommonTypes\AbstractMacros.fs"))
            {
...
open CommonTypes
(*
Initially generated by the C stg macros with the following command
